...
> The Syncfusion ASP.NET Core UI Scaffolder is available from v17.4.0.39 for ASP.NET Core MVC application  and provided the Scaffolding support to ASP.NET Core web application from 18.4.0.39.
