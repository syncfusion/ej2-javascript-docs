...
The Syncfusion JavaScript (ES5) library provides the set of `base64` formatted font icons, that can be utilized in the web application.
...
The Syncfusion JavaScript icon library can be customize its color, size by overriding the `e-icons` class.
