...
{% tab template= "diagram/shapes", es5Template="es5Text" %}
...
{% tab template= "diagram/shapes", es5Template="es5ImageBase64" %}
...
{% tab template= "diagram/shapes", es5Template="es5Native" %}
...
{% tab template= "diagram/shapes", es5Template="es5Basic" %}
...
{% tab template= "diagram/shapes", es5Template="es5Path" %}
...
{% tab template= "diagram/shapes", es5Template="es5Flow" %}
