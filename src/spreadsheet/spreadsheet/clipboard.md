...
let copyButton: Button = new Button({content: 'Copy'});
copyButton.appendTo('#copyButton');
document.getElementById('copyButton').onclick = (): void => {
    spreadsheet.copy();
}
let cutButton: Button = new Button({content: 'Cut'});
cutButton.appendTo('#cutButton');
document.getElementById('cutButton').onclick = (): void => {
    spreadsheet.cut();
}
let pasteButton: Button = new Button({content: 'Paste'});
pasteButton.appendTo('#pasteButton');
document.getElementById('pasteButton').onclick = (): void => {
    spreadsheet.paste();
}
