...
description: "This section explains how to create a simple Syncfusion JavaScript (ECMAScript5) drop-down list control and configure it's functionalities."
---
...
{% tab template="dropdownlist/es5-getting-started", sourceFiles="index.html" %}
