...
{% tab template="card/card_header_img", isDefaultActive=true, sourceFiles="index.html,index.css" %}
...
{% tab template="card/card_content", sourceFiles="index.html,index.css" %}
