...
{% tab template="document-editor/read", es5Template="read-only-sfdt", sourceFiles="index.ts,index.html" %}
...
{% tab template="document-editor/read-container", isDefaultActive=true, es5Template="read-only-container-sfdt", sourceFiles="index.ts,index.html" %}
