...
{% tab template="badge/color", isDefaultActive = "true", sourceFiles="index.html", es5Template="basic-template" %}
...
{% tab template="badge/size", isDefaultActive = "true", sourceFiles="index.html", es5Template="basic-template" %}
...
{% tab template="badge/custom-position", isDefaultActive = "true", sourceFiles="index.html", es5Template="basic-template" %}
