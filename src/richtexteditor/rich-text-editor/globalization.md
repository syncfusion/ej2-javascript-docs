...
description: "This section explains the localization support of Syncfusion JavaScript Rich Text Editor control."
---
...
{% tab template="rich-text-editor/getting-started", es5Template="locale" %}
...
{% tab template="rich-text-editor/getting-started", es5Template="rtl" %}
